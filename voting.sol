...
contract Voting is Ownable {
  ...
  function giveVote(uint _proposal_id, bool _voteDecision) external {
    require(address_to_proposalIdArr[address(msg.sender)][_proposal_id] == false, "you have already voted for this proposal");
    address_to_proposalIdArr[address(msg.sender)][_proposal_id] = true;
